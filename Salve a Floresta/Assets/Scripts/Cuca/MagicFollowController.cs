...
public class MagicFollowController : MonoBehaviour
{
    ...
    void Start()
    {
        target = GameObject.FindGameObjectWithTag("Player").transform; // Encontra o jogador na cena pelo tag e obtém seu Transform
    ...
    void Update()
    {
        if (target != null)
        {
            // Move a esfera em direção ao jogador com a velocidade definida
